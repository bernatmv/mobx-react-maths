export default class EventConstants {
    ...
    static get CalculateRetenciones() { return 'CalculateRetenciones'; }
    static get CalculateBonos() { return 'CalculateBonos'; }
    static get CalculateMinigames() { return 'CalculateMinigames'; }
}